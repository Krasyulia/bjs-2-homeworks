describe('Домашнее задание к лекции «Обработка исключений и замыкания»', () => {
    ...
    describe('Задача №2', () => {
        ...
        it('функция getTriangle не должна возвращать объект треугольника', () => {
            ...
            expect(triangle.message).toEqual('Ошибка! Треугольник не существует');
            // не понимаю как это должно работать если объект не существует и метод соответственно тоже
